...
setlocal
set "ROOT_DIR=%~dp0..\.."
set "API_CONFIG=%ROOT_DIR%\API\appsettings.Development.json"
set "CLIENT_CONFIG=%ROOT_DIR%\client\.env.devpublish"
set "PWA_CONFIG=%ROOT_DIR%\doa_donatur_pwa\.env.devpublish"
