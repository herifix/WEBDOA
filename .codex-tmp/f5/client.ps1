...
$serviceName = 'client'
$logPath = 'D:\KANTOR\Project VB\WEB DOA\.codex-tmp\f5\client.log'
$logDirectory = Split-Path -Parent $logPath
if (-not [string]::IsNullOrWhiteSpace($logDirectory)) {
    New-Item -ItemType Directory -Force -Path $logDirectory | Out-Null
}
Set-Content -LiteralPath $logPath -Value "" -Encoding UTF8
Set-Location -LiteralPath 'D:\KANTOR\Project VB\WEB DOA\client'
$env:VITE_API_PROXY_TARGET = 'http://127.0.0.1:5178'
$command = 'npm.cmd'
